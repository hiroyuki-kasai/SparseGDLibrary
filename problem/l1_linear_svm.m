function Problem = l1_linear_svm(x_train, y_train, x_test, y_test, lambda)
% This file defines l1-regularized SVM problem
%
% Inputs:
...
%         lambda = varargin{1};
    ...
    function g = grad(w, indices)
        ...
        g = - sum(coeff .* x_train(:,indices),2)/length(indices);  
